...
<!--four-grids here-->
      ...
      <!-- <a href="<?=base_url()?>home/add_about" class="btn btn-info">Tambah</a> -->
        ...
        <table id="daftar" class="table table-striped">
          ...
          <tbody>
            ...
            <tr>
              <td><?=$a->id ?></td>
              <td><?=htmlentities($a->foto) ?></td>
              <td><?=$a->caption ?></td>
              <td><?=$a->judul ?></td>
              <td><?=$a->foto2 ?></td>
              <td><?=$a->caption2 ?></td>
              <td><?=$a->judul2 ?></td>
              <td><a href="<?=base_url()?>home/edit_about/<?php echo $a->id ?>" class="btn btn-success">Edit</a><a href="<?=base_url()?>home/delete_about/<?php echo $a->id ?>" class="btn btn-danger">Delete</a></td>
            </tr>
          <?php } ?>
          </tbody>
        </table>
