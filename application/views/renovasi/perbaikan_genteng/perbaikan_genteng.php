...
<body>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 col-sm-12">
          <h1 class="wow fadeInDown">PERBAIKAN GENTENG</h1>
  ...
  <section id="renovasi" class="parallax-section">
        <div class="row">
          ...
          <div class="col">
            <img class="gambar" src="<?=base_url("assets/renovasi/perbaikan-genteng/$genteng->gambar")?>" alt="sample57" />
            <h2><?=$genteng->judul?></h2>
            <p><?=$genteng->deskripsi?></p>
          </div>
        <?php } ?>
        </div>
      </section>
