...
<!--four-grids here-->
      ...
      <!--<a href="<?=base_url()?>home/add_furniture" class="btn btn-info">Tambah</a>-->
        ...
        <table id="daftar" class="table table-striped">
          ...
          <tbody>
            ...
            <tr>
              <td><?=$this->security->xss_clean($f->id_furniture) ?></td>
              <td><?=$this->security->xss_clean($f->fur_kategori) ?></td>
              <td><?=$this->security->xss_clean($f->img_fur) ?></td>
              <td><a href="<?=base_url()?>home/edit_furniture/<?php echo $f->id_furniture ?>" class="btn btn-success">Edit</a><a href="<?=base_url()?>home/delete_furniture/<?php echo $f->id_furniture ?>" class="btn btn-danger">Delete</a></td>
            </tr>
          <?php } ?>
          </tbody>
        </table>
