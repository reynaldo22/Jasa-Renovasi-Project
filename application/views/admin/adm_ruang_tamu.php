...
<!--four-grids here-->
      ...
      <a href="<?=base_url()?>home/add_ruang_tamu" class="btn btn-info">Tambah</a>
        ...
        <table id="daftar" class="table table-striped">
          ...
          <tbody>
            <?php foreach($ruang_tamu as $tamu) { ?>
            <tr>
              <td><?=$this->security->xss_clean($tamu->id) ?></td>
              <td><?=$this->security->xss_clean($tamu->nama) ?></td>
              <td><?=$this->security->xss_clean($tamu->gambar) ?></td>
              <td><?=$this->security->xss_clean($tamu->harga) ?></td>
              <td><a href="<?=base_url()?>home/edit_ruang_tamu/<?php echo $tamu->id ?>" class="btn btn-success">Edit</a><a href="<?=base_url()?>home/delete_ruang_tamu/<?php echo $tamu->id ?>" class="btn btn-danger">Delete</a></td>
            </tr>
          <?php } ?>
          </tbody>
        </table>
