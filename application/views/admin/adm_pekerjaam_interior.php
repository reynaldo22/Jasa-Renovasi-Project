...
<!--four-grids here-->
      ...
      <a href="<?=base_url()?>home/add_pekerjaan_interior" class="btn btn-info">Tambah</a>
        ...
        <table id="daftar" class="table table-striped">
          ...
          <tbody>
            ...
            <tr>
              <td><?=$this->security->xss_clean($interior->id) ?></td>
              <td><?=$this->security->xss_clean($interior->judul) ?></td>
              <td><?=$this->security->xss_clean($interior->gambar) ?></td>
              <td><?=$this->security->xss_clean($interior->deskripsi) ?></td>
              <td>
                <a href="<?=base_url()?>home/edit_pekerjaan_interior/<?php echo $interior->id ?>" class="btn btn-success">Edit</a>
                <a href="<?=base_url()?>home/delete_pekerjaan_interior/<?php echo $interior->id ?>" class="btn btn-danger">Delete</a>
              </td>
            </tr>
          <?php } ?>
          </tbody>
