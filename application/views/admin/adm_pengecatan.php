...
<!--four-grids here-->
      ...
      <a href="<?=base_url()?>home/add_pengecatan" class="btn btn-info">Tambah</a>
        ...
        <table id="daftar" class="table table-striped">
          ...
          <tbody>
            <?php foreach($pengecatan as $cat) { ?>
            <tr>
              <td><?=$this->security->xss_clean($cat->id) ?></td>
              <td><?=$this->security->xss_clean($cat->judul) ?></td>
              <td><?=$this->security->xss_clean($cat->gambar) ?></td>
              <td><?=$this->security->xss_clean($cat->deskripsi) ?></td>
              <td>
                <a href="<?=base_url()?>home/edit_pengecatan/<?php echo $cat->id ?>" class="btn btn-success">Edit</a>
                <a href="<?=base_url()?>home/delete_pengecatan/<?php echo $cat->id ?>" class="btn btn-danger">Delete</a>
              </td>
            </tr>
          <?php } ?>
          </tbody>
