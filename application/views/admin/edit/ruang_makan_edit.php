...
<!--four-grids here-->
      ...
      <form class="" action="<?=base_url()?>home/update_ruang_makan" method="post" enctype="multipart/form-data">
        <input type="hidden" name="id" value="<?=$ruang_makan->id;?>">

        <div class="form-group">
          <label for="nama">Nama</label>
          <input type="text" name="nama" class="form-control" id="nama" placeholder="nama" value="<?=$ruang_makan->nama?>">
        </div>

        <div class="form-group">
          <label for="gambar">Gambar</label>
          <input type="text" name="gambar" class="form-control" id="gambar" placeholder="gambar" value="<?=$ruang_makan->gambar?>">
        </div>

        <div class="form-group">
          <label for="harga">Harga</label>
          <input type="text" name="harga" class="form-control" id="harga" placeholder="harga" value="<?=$ruang_makan->harga?>">
        </div>
