...
<!--four-grids here-->
      ...
      <form class="" action="<?=base_url()?>home/update_renovasi" method="post" enctype="multipart/form-data">
        <input type="hidden" name="id" value="<?=$renovasi->id;?>">

        <div class="form-group">
          <label for="renov_kategori">Kategori</label>
          <input type="text" name="renov_kategori" class="form-control" id="renov_kategori" placeholder="Kategori" value="<?=$renovasi->renov_kategori?>">
        </div>

        <div class="form-group">
          <label for="img_renov">Gambar</label>
          <input type="text" name="img_renov" class="form-control" id="img_renov" placeholder="gambar" value="<?=$renovasi->img_renov?>">
        </div>
