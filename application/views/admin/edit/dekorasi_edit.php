...
<!--four-grids here-->
      ...
      <form class="" action="<?=base_url()?>home/update_dekorasi" method="post" enctype="multipart/form-data">
        <input type="hidden" name="id" value="<?=$dekorasi->id;?>">

        <div class="form-group">
          <label for="nama">Nama</label>
          <input type="text" name="nama" class="form-control" id="nama" placeholder="nama" value="<?=$dekorasi->nama?>">
        </div>

        <div class="form-group">
          <label for="gambar">Gambar</label>
          <input type="text" name="gambar" class="form-control" id="gambar" placeholder="gambar" value="<?=$dekorasi->gambar?>">
        </div>

        <div class="form-group">
          <label for="harga">Harga</label>
          <input type="text" name="harga" class="form-control" id="harga" placeholder="harga" value="<?=$dekorasi->harga?>">
        </div>
