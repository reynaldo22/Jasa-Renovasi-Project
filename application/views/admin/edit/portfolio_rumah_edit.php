...
<html>
<head>
<title>Edit portfolio rumah</title>
...
<!--four-grids here-->
      ...
      <form class="" action="<?=base_url()?>home/update_rumah" method="post" enctype="multipart/form-data">
        <input type="hidden" name="id" value="<?=$rumah->id;?>">

        <div class="form-group">
          <label for="judul">Judul</label>
          <input type="text" name="judul" class="form-control" id="judul" placeholder="judul" value="<?=$rumah->judul?>">
        </div>

        <div class="form-group">
          <label for="foto">Foto</label>
          <input type="text" name="foto" class="form-control" id="foto" placeholder="foto" value="<?=$rumah->foto?>">
        </div>

        <div class="form-group">
          <label for="deskripsi">Deskripsi</label>
          <textarea class="form-control" name="deskripsi" id="deskripsi" placeholder="Deskripsi"><?=$rumah->deskripsi?></textarea>
        </div>
