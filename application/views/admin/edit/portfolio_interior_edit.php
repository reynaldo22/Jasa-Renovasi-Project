...
<html>
<head>
<title>Edit portfolio interior</title>
...
<!--four-grids here-->
      ...
      <form class="" action="<?=base_url()?>home/update_interior" method="post" enctype="multipart/form-data">
        <input type="hidden" name="id" value="<?=$interior->id;?>">

        <div class="form-group">
          <label for="judul">Judul</label>
          <input type="text" name="judul" class="form-control" id="judul" placeholder="judul" value="<?=$interior->judul?>">
        </div>

        <div class="form-group">
          <label for="foto">Foto</label>
          <input type="text" name="foto" class="form-control" id="foto" placeholder="foto" value="<?=$interior->foto?>">
        </div>

        <div class="form-group">
          <label for="deskripsi">Deskripsi</label>
          <textarea class="form-control" name="deskripsi" id="deskripsi" placeholder="Deskripsi"><?=$interior->deskripsi?></textarea>
        </div>
