...
<html>
<head>
<title>Edit perbaikan genteng</title>
...
<!--four-grids here-->
      ...
      <form class="" action="<?=base_url()?>home/update_perbaikan_genteng" method="post" enctype="multipart/form-data">
        <input type="hidden" name="id" value="<?=$perbaikan_genteng->id;?>">

        <div class="form-group">
          <label for="judul">Judul</label>
          <input type="text" name="judul" class="form-control" id="judul" placeholder="judul" value="<?=$perbaikan_genteng->judul?>">
        </div>

        <div class="form-group">
          <label for="gambar">Gambar</label>
          <input type="text" name="gambar" class="form-control" id="gambar" placeholder="gambar" value="<?=$perbaikan_genteng->gambar?>">
        </div>

        <div class="form-group">
          <label for="deskripsi">Deskripsi</label>
          <textarea class="form-control" name="deskripsi" id="deskripsi" placeholder="deskripsi"><?=$perbaikan_genteng->deskripsi?></textarea>
        </div>
