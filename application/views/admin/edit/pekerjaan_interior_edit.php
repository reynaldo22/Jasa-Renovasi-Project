...
<html>
<head>
<title>Edit pekerjaan interior</title>
...
<!--four-grids here-->
      ...
      <form class="" action="<?=base_url()?>home/update_pekerjaan_interior" method="post" enctype="multipart/form-data">
        <input type="hidden" name="id" value="<?=$pekerjaan_interior->id;?>">

        <div class="form-group">
          <label for="judul">Judul</label>
          <input type="text" name="judul" class="form-control" id="judul" placeholder="judul" value="<?=$pekerjaan_interior->judul?>">
        </div>

        <div class="form-group">
          <label for="gambar">Gambar</label>
          <input type="text" name="gambar" class="form-control" id="gambar" placeholder="gambar" value="<?=$pekerjaan_interior->gambar?>">
        </div>

        <div class="form-group">
          <label for="deskripsi">Deskripsi</label>
          <textarea class="form-control" name="deskripsi" id="deskripsi" placeholder="deskripsi"><?=$pekerjaan_interior->deskripsi?></textarea>
        </div>
