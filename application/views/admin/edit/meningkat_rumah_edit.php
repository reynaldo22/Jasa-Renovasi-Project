...
<html>
<head>
<title>Edit meningkat rumah</title>
...
<!--four-grids here-->
      ...
      <form class="" action="<?=base_url()?>home/update_meningkat_rumah" method="post" enctype="multipart/form-data">
        <input type="hidden" name="id" value="<?=$meningkat_rumah->id;?>">

        <div class="form-group">
          <label for="judul">Judul</label>
          <input type="text" name="judul" class="form-control" id="judul" placeholder="judul" value="<?=$meningkat_rumah->judul?>">
        </div>

        <div class="form-group">
          <label for="gambar">Gambar</label>
          <input type="text" name="gambar" class="form-control" id="gambar" placeholder="gambar" value="<?=$meningkat_rumah->gambar?>">
        </div>

        <div class="form-group">
          <label for="deskripsi">Deskripsi</label>
          <textarea class="form-control" name="deskripsi" id="deskripsi" placeholder="deskripsi"><?=$meningkat_rumah->deskripsi?></textarea>
        </div>
