...
<!--four-grids here-->
      ...
      <form class="" action="<?=base_url()?>home/update_testimonial" method="post" enctype="multipart/form-data">
        <input type="hidden" name="id" value="<?=$testimonial->id;?>">

        <div class="form-group">
          <label for="nama">Nama</label>
          <input type="text" name="nama" class="form-control" id="nama" placeholder="nama" value="<?=$testimonial->nama?>">
        </div>

        <div class="form-group">
          <label for="foto">Gambar</label>
          <input type="text" name="foto" class="form-control" id="foto" placeholder="foto" value="<?=$testimonial->foto?>">
        </div>

        <div class="form-group">
          <label for="profesi">Profesi</label>
          <input type="text" name="profesi" class="form-control" id="profesi" placeholder="profesi" value="<?=$testimonial->profesi?>">
        </div>

        <div class="form-group">
          <label for="caption">Caption</label>
          <textarea class="form-control" name="caption" id="caption" placeholder="Caption"><?=$testimonial->caption?></textarea>
        </div>
