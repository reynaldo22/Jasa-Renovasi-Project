...
<!--four-grids here-->
      ...
      <form class="" action="<?=base_url()?>home/update_furniture" method="post" enctype="multipart/form-data">
        <input type="hidden" name="id" value="<?=$furniture->id_furniture;?>">

        <div class="form-group">
          <label for="fur_kategori">Kategori</label>
          <input type="text" name="fur_kategori" class="form-control" id="fur_kategori" placeholder="kategori" value="<?=$furniture->fur_kategori?>">
        </div>

        <div class="form-group">
          <label for="img_fur">Foto</label>
          <input type="text" name="img_fur" class="form-control" id="img_fur" placeholder="foto" value="<?=$furniture->img_fur?>">
        </div>
