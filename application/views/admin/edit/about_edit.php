...
<!--four-grids here-->
      ...
      <form class="" action="<?=base_url()?>home/update_about" method="post" enctype="multipart/form-data">
        <input type="hidden" name="id" value="<?=$about->id;?>">

        <div class="form-group">
          <label for="foto">Foto</label>
          <input type="text" name="foto" class="form-control" id="foto" placeholder="foto" value="<?=$about->foto?>">
        </div>

        <div class="form-group">
          <label for="caption">Caption</label>
          <textarea class="form-control" name="caption" id="caption" placeholder="Caption"><?=$about->caption?></textarea>
        </div>

        <div class="form-group">
          <label for="judul">Judul</label>
          <input type="text" name="judul" class="form-control" id="judul" placeholder="Judul" value="<?=$about->judul?>">
        </div>

        <div class="form-group">
          <label for="foto2">Foto 2</label>
          <input type="text" name="foto2" class="form-control" id="foto2" placeholder="foto 2" value="<?=$about->foto2?>">
        </div>
        ...
        <div class="form-group">
          ...
          <input type="text" name="judul2" class="form-control" id="judul2" placeholder="Judul 2" value="<?=$about->judul2?>">
        </div>
