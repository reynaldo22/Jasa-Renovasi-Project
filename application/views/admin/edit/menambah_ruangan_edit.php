...
<html>
<head>
<title>Edit menambah ruangan</title>
...
<!--four-grids here-->
      ...
      <form class="" action="<?=base_url()?>home/update_menambah_ruangan" method="post" enctype="multipart/form-data">
        <input type="hidden" name="id" value="<?=$menambah_ruangan->id;?>">

        <div class="form-group">
          <label for="judul">Judul</label>
          <input type="text" name="judul" class="form-control" id="judul" placeholder="judul" value="<?=$menambah_ruangan->judul?>">
        </div>

        <div class="form-group">
          <label for="gambar">Gambar</label>
          <input type="text" name="gambar" class="form-control" id="gambar" placeholder="gambar" value="<?=$menambah_ruangan->gambar?>">
        </div>

        <div class="form-group">
          <label for="deskripsi">Deskripsi</label>
          <textarea class="form-control" name="deskripsi" id="deskripsi" placeholder="deskripsi"><?=$menambah_ruangan->deskripsi?></textarea>
        </div>
