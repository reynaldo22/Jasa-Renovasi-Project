...
<!--four-grids here-->
      ...
      <form class="" action="<?=base_url()?>home/update_kamar_mandi" method="post" enctype="multipart/form-data">
        <input type="hidden" name="id" value="<?=$kamar_mandi->id;?>">

        <div class="form-group">
          <label for="nama">Nama</label>
          <input type="text" name="nama" class="form-control" id="nama" placeholder="nama" value="<?=$kamar_mandi->nama?>">
        </div>

        <div class="form-group">
          <label for="gambar">Gambar</label>
          <input type="text" name="gambar" class="form-control" id="gambar" placeholder="gambar" value="<?=$kamar_mandi->gambar?>">
        </div>

        <div class="form-group">
          <label for="harga">Harga</label>
          <input type="text" name="harga" class="form-control" id="harga" placeholder="harga" value="<?=$kamar_mandi->harga?>">
        </div>
