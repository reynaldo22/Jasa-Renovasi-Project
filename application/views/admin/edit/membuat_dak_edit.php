...
<!--four-grids here-->
      ...
      <form class="" action="<?=base_url()?>home/update_membuat_dak" method="post" enctype="multipart/form-data">
        <input type="hidden" name="id" value="<?=$membuat_dak->id;?>">

        <div class="form-group">
          <label for="judul">Judul</label>
          <input type="text" name="judul" class="form-control" id="judul" placeholder="judul" value="<?=$membuat_dak->judul?>">
        </div>

        <div class="form-group">
          <label for="gambar">Gambar</label>
          <input type="text" name="gambar" class="form-control" id="gambar" placeholder="gambar" value="<?=$membuat_dak->gambar?>">
        </div>

        <div class="form-group">
          <label for="deskripsi">Deskripsi</label>
          <textarea class="form-control" name="deskripsi" id="deskripsi" placeholder="deskripsi"><?=$membuat_dak->deskripsi?></textarea>
        </div>
