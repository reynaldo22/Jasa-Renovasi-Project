...
<html>
<head>
<title>Edit membangun ruko</title>
...
<!--four-grids here-->
      ...
      <form class="" action="<?=base_url()?>home/update_membangun_ruko" method="post" enctype="multipart/form-data">
        <input type="hidden" name="id" value="<?=$membangun_ruko->id;?>">

        <div class="form-group">
          <label for="judul">Judul</label>
          <input type="text" name="judul" class="form-control" id="judul" placeholder="judul" value="<?=$membangun_ruko->judul?>">
        </div>

        <div class="form-group">
          <label for="gambar">Gambar</label>
          <input type="text" name="gambar" class="form-control" id="gambar" placeholder="gambar" value="<?=$membangun_ruko->gambar?>">
        </div>

        <div class="form-group">
          <label for="deskripsi">Deskripsi</label>
          <textarea class="form-control" name="deskripsi" id="deskripsi" placeholder="Caption"><?=$membangun_ruko->deskripsi?></textarea>
        </div>
