...
<!--four-grids here-->
      ...
      <a href="<?=base_url()?>home/add_rumah" class="btn btn-info">Tambah</a>
        ...
        <table id="daftar" class="table table-striped">
          ...
          <tbody>
            ...
            <tr>
              <td><?=$this->security->xss_clean($r->id) ?></td>
              <td><?=$this->security->xss_clean($r->judul) ?></td>
              <td><?=$this->security->xss_clean($r->foto) ?></td>
              <td><?=$this->security->xss_clean($r->deskripsi) ?></td>
              <td>
                <a href="<?=base_url()?>home/edit_rumah/<?php echo $r->id ?>" class="btn btn-success">Edit</a>
                <a href="<?=base_url()?>home/delete_rumah/<?php echo $r->id ?>" class="btn btn-danger">Delete</a>
              </td>
            </tr>
          <?php } ?>
          </tbody>
