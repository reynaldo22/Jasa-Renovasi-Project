...
<!--four-grids here-->
      ...
      <a href="<?=base_url()?>home/add_ruko" class="btn btn-info">Tambah</a>
        ...
        <table id="daftar" class="table table-striped">
          ...
          <tbody>
            ...
            <tr>
              <td><?=$this->security->xss_clean($ru->id) ?></td>
              <td><?=$this->security->xss_clean($ru->judul) ?></td>
              <td><?=$this->security->xss_clean($ru->foto) ?></td>
              <td><?=$this->security->xss_clean($ru->deskripsi) ?></td>
              <td>
                <a href="<?=base_url()?>home/edit_ruko/<?php echo $ru->id ?>" class="btn btn-success">Edit</a>
                <a href="<?=base_url()?>home/delete_ruko/<?php echo $ru->id ?>" class="btn btn-danger">Delete</a>
              </td>
            </tr>
          <?php } ?>
          </tbody>
