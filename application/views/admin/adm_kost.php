...
<!--four-grids here-->
      ...
      <a href="<?=base_url()?>home/add_kost" class="btn btn-info">Tambah</a>
        ...
        <table id="daftar" class="table table-striped">
          ...
          <tbody>
            ...
            <tr>
              <td><?=$this->security->xss_clean($k->id) ?></td>
              <td><?=$this->security->xss_clean($k->judul) ?></td>
              <td><?=$this->security->xss_clean($k->gambar) ?></td>
              <td><?=$this->security->xss_clean($k->deskripsi) ?></td>
              <td>
                <a href="<?=base_url()?>home/edit_kost/<?php echo $k->id ?>" class="btn btn-success">Edit</a>
                <a href="<?=base_url()?>home/delete_kost/<?php echo $k->id ?>" class="btn btn-danger">Delete</a>
              </td>
            </tr>
          <?php } ?>
          </tbody>
