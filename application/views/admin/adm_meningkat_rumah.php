...
<!--four-grids here-->
      ...
      <a href="<?=base_url()?>home/add_meningkat_rumah" class="btn btn-info">Tambah</a>
        ...
        <table id="daftar" class="table table-striped">
          ...
          <tbody>
            ...
            <tr>
              <td><?=$this->security->xss_clean($tingkat->id) ?></td>
              <td><?=$this->security->xss_clean($tingkat->judul) ?></td>
              <td><?=$this->security->xss_clean($tingkat->gambar) ?></td>
              <td><?=$this->security->xss_clean($tingkat->deskripsi) ?></td>
              <td>
                <a href="<?=base_url()?>home/edit_meningkat_rumah/<?php echo $tingkat->id ?>" class="btn btn-success">Edit</a>
                <a href="<?=base_url()?>home/delete_meningkat_rumah/<?php echo $tingkat->id ?>" class="btn btn-danger">Delete</a>
              </td>
            </tr>
          <?php } ?>
          </tbody>
