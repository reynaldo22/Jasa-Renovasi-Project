...
<!--four-grids here-->
      ...
      <!-- <a href="<?=base_url()?>home/add_membangun" class="btn btn-info">Tambah</a> -->
        ...
        <table id="daftar" class="table table-striped">
          ...
          <tbody>
            ...
            <tr>
              <td><?=$this->security->xss_clean($m->id_membangun) ?></td>
              <td><?=$this->security->xss_clean($m->m_kategori) ?></td>
              <td><?=$this->security->xss_clean($m->img_membangun) ?></td>
              <td>
                <a href="<?=base_url()?>home/edit_membangun/<?php echo $m->id_membangun ?>" class="btn btn-success">Edit</a>
                <a href="<?=base_url()?>home/delete_membangun/<?php echo $m->id_membangun ?>" class="btn btn-danger">Delete</a>
              </td>
            </tr>
          <?php } ?>
          </tbody>
