...
<!--four-grids here-->
      ...
      <!-- <a href="<?=base_url()?>home/add_renovasi" class="btn btn-info">Tambah</a> -->
        ...
        <table id="daftar" class="table table-striped">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?=$this->security->xss_clean($r->renov_kategori) ?></td>
              <td><?=$this->security->xss_clean($r->img_renov) ?></td>
              <td>
                <a href="<?=base_url()?>home/edit_renovasi/<?php echo $r->id ?>" class="btn btn-success">Edit</a>
                <a href="<?=base_url()?>home/delete_renovasi/<?php echo $r->id ?>" class="btn btn-danger">Delete</a>
              </td>
            </tr>
          <?php } ?>
          </tbody>
