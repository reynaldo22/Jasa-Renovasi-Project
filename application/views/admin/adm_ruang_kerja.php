...
<!--four-grids here-->
      ...
      <a href="<?=base_url()?>home/add_ruang_kerja" class="btn btn-info">Tambah</a>
        ...
        <table id="daftar" class="table table-striped">
          ...
          <tbody>
            ...
            <tr>
              <td><?=$this->security->xss_clean($kerja->id) ?></td>
              <td><?=$this->security->xss_clean($kerja->nama) ?></td>
              <td><?=$this->security->xss_clean($kerja->gambar) ?></td>
              <td><?=$this->security->xss_clean($kerja->harga) ?></td>
              <td><a href="<?=base_url()?>home/edit_ruang_kerja/<?php echo $kerja->id ?>" class="btn btn-success">Edit</a><a href="<?=base_url()?>home/delete_ruang_kerja/<?php echo $kerja->id ?>" class="btn btn-danger">Delete</a></td>
            </tr>
          <?php } ?>
          </tbody>
        </table>
